...
// --- PASTE ALL YOUR DATA AND FUNCTIONS FOR THE FIRST ASSESSMENT HERE ---
const competencyMap = {
...
// --- Use router.get, router.post, etc. instead of app.get ---
router.get('/case-study', (req, res) => {
    const questionsForFrontend = caseStudyData.questions.map(({ bestAnswer, ...rest }) => rest);
    const payload = { ...caseStudyData, questions: questionsForFrontend };
    res.json(payload);
});
